      ...
      <div className="p-5 h-1/3 flex flex-col justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1 line-clamp-2">
            {set.short_description || set.collection?.name || "Exclusive Collection"}
          </p>
        </div>
        ...
        <div className="flex items-center justify-between mt-3">
          <div>
            ...
            <p className="text-primary font-serif text-lg">
              {basePrice > 0 ? `${basePrice.toLocaleString()} BHD` : "Price on request"}
            </p>
          </div>
